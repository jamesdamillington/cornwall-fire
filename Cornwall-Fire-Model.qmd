...
Now we can calculate Fire Danger using the McArthur grassland fire danger model for Grassland and Heathland fuel types (land covers) using their respective curing and biomass values, and the forest fire danger model for the Deciduous and Conifer types for their curing and biomass values.
